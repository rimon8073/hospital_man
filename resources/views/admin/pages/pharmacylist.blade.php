...
<div class="grid_10">
    ...
    <a href="{{URL::to('pharmacylist')}}"><span style="border-bottom: 2px solid black" class="btn btn-light">Pharmacy List</span></a>
...
@endif
            ...
            @foreach ($pharmacylist as $pharmacy)
              ...
              <td>
                <img src="images/employee/{{$pharmacy->emp_image}}" alt="IMG" style="width:100px;height:50px;">
                </td>
              <td>{{ $pharmacy->emp_name }}</td>
							<td>{{ $pharmacy->emp_email }}</td>
							<td>{{ $pharmacy->emp_mobile }}</td>
              <td><a class="btn btn-xs btn-success" href="{{Route('pharmacyview')}}/{{ $pharmacy->id }}"><i class="fa fa-eye"></i></a> <a class="btn btn-xs btn-primary" href="{{Route('pharmacyedit')}}/{{$pharmacy->id}}"><i class="fa fa-edit"></i></a> <a class="btn btn-xs btn-danger" href="{{Route('pharmacydelete')}}/{{$pharmacy->id}}"><i class="fa fa-trash"></i></a></td>
